 ...
 */
public class ExtractCDXJobForWarc extends WARCBatchJob {
     ...
     */
    public ExtractCDXJobForWarc(boolean includeChecksum) {
    ...
    public WARCBatchFilter getFilter() {
        ...
        return WARCBatchFilter.ONLY_HTTP_ENTRIES;
    }
    ...
    public void processRecord(WARCRecord sar, OutputStream os) {
        ...
        */
        ...
        fieldsread.put("A", sar.getHeader().getUrl());
        //fieldsread.put("e", sar.getHeader().getUrl());
        fieldsread.put("b", sar.getHeader().getDate());
        fieldsread.put("m", sar.getHeader().getMimetype());
