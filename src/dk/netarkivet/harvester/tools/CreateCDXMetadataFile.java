...
public class CreateCDXMetadataFile extends ToolRunnerBase {
    ...
    private static class CreateCDXMetadataFileTool
         ...
         * If combined with a harvestnameprefix, this will match filenames that begin
         * with the given harvestname prefix.
         * 
         */
        ...
        public boolean checkArgs(String... args) { 
            ...
            Option harvestprefixOption = new Option(HARVESTNAMEPREFIX_OPTION_KEY, 
                    true, "The harvestnamePrefix");
            ...
            try {
                ...
                if (jobId < 1) {
                    System.err.println("'" + jobIdString
            ...
            try {
                ...
                if (harvestId < 1) {
                    System.err.println("'" + harvestIdString
                            + "' is not a harvest job ID");
                    return false;
                }
            } catch (NumberFormatException e) {
        ...
        private String parseLine(String line, String harvestnamePrefix) {
            try {
                ...
                if (!filename.startsWith(harvestnamePrefix)) {
                    System.err.println("Found CXD-entry with unexpected filename '"
                            + filename + "': does not match harvestnamePrefix '" +
                            		 harvestnamePrefix + "' in " + line);
                    return null;
                }
                return filename;
         ...
         * @param filename The filename of all the entries stored in baos.  This
